;(function($, acf_relationship_create, wp, undefined) {
    ...
    $(document).ready(function() {
        ...
        function callback( post_id, post_title) {
            console.log('callback called', post_id, post_title);
        ...
        if( typeof wp === 'object' && typeof wp.apiFetch === 'function') {
            wp.apiFetch.use(function (options, next) {
                ...
                result.then(function () {
                    if (typeof options.path !== 'string' || typeof options.method !== 'string' || options.method !== 'PUT' )
                        return;
        ...
        if( $post_id_input.length === 1 && $post_id_input.val() != '') {
            callback( $post_id_input.val(), $('form#post input[name="post_title"]').val() );
        }
    });
